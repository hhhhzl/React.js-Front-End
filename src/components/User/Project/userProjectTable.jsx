...
function ActionsFormatter(props) {
    const [disable, setDisable] = useState(props.value.is_active === '停用');

    return (
        <div>
            <Link to={`/qnaire/${props.value.id}/qanswer`}>
                <Button disabled={disable} title={props.value.name}>填写</Button>
            </Link>
        </div>
    );
}
