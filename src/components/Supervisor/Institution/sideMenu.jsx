    ...
    <div className='side-menu'>
      <Nav>
        ...
        <Navbar className='side-text' expand="lg">
          <Nav.Link style={{ color: "hsl(209, 76%, 67%)"  }} href="/institution-interface"><AccountBalanceIcon />机构设置</Nav.Link>
        </Navbar>
        <Navbar className='side-text' expand="lg">
          <Nav.Link style={{ color: "white" }} href="/staffing-interface"><AccountBoxIcon />人员设置</Nav.Link>
        </Navbar>
      </Nav>
    </div>
  )
